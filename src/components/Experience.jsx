  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        className=""
      >
        {/* EXPERIENCE LIST ITEM - Software Engineer */}
        <div className="flex justify-between h-48 relative">
          {/* LEFT */}
          <div className="w-1/3">
        ...
        {/* EXPERIENCE LIST ITEM - Software Developer Intern */}
      ...
      {/* MODAL - Software Developer Intern */}
